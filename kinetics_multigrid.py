...
class Kinetics(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.temporal_transform is not None:
            ...
            frame_indices = self.temporal_transform(frame_indices, t_stride, sample_duration) # for stride=5, frames [4,8,16]
        ...
        return clip, target, long_cycle_state, stats, self.data[index]['video_id']
